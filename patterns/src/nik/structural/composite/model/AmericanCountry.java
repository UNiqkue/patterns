...
public class AmericanCountry implements Country {
    private final String name;
    private final String capital;
    private final List<String> districts;
    private final List<String> cities;

    public AmericanCountry(String name, String capital, List<String> districts, List<String> cities) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        AmericanCountry that = (AmericanCountry) o;
